...
using DinerMax3000.Business.dsDiner3000TableAdapters;
...
namespace DinerMax3000.Business
{
    public class Menu
    {
        ...
        public static List<Menu> GetAllMenus()
        {
            ...
            foreach(dsDiner3000.MenuRow menuRow in dtMenu.Rows)
            {
                ...
                foreach(dsDiner3000.MenuItemRow menuItemRow in dtMenuItems.Rows)
                {
